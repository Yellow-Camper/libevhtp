...
# Modifications by Mark Ellzey <ellzey@strcpy.net>
...
fin = os.popen('git log --summary --stat --no-merges --date=short %s..%s' % (old_tag, new_tag), 'r')

os.system("mv ChangeLog bak.ChangeLog")
...
os.system("cat bak.ChangeLog >> ChangeLog")
os.system("rm bak.ChangeLog")
